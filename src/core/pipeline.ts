...
import { 
  ...
  calculateGPTReplyCost, 
  calculateLocalOperationCost, 
...
export async function runPipeline(text: string) {
  ...
  stepCosts.push(createStepCost(
    "RAW_TEXT_IN",
    step1Latency,
    step1Costs.cost,
    step1Costs.processingUnits,
  ...
  stepCosts.push(createStepCost(
    ...
    step2Costs.cost,
    step2Costs.tokens,
    "Generate text embedding vector using AI service",
    "ai"
  ));
  ...
  stepCosts.push(createStepCost(
    ...
    step3Latency,
    step3Costs.cost,
    step3Costs.processingUnits,
    "Load last 5 diary entries",
    "database"
  ));
  ...
  stepCosts.push(createStepCost(
    ...
    step5Latency,
    step5Costs.cost,
    step5Costs.processingUnits,
    "Extract metadata from text (word count, punctuation)",
    "local"
  ));
  ...
  stepCosts.push(createStepCost(
    ...
    step6Latency,
    step6Costs.cost,
    step6Costs.processingUnits,
    "Parse entry themes, vibes, intents using pattern matching",
    "local"
  ));
  ...
  stepCosts.push(createStepCost(
    ...
    step7Latency,
    step7Costs.cost,
    step7Costs.processingUnits,
    "Check theme/vibe overlap with recent entries",
    "local"
  ));
  ...
  stepCosts.push(createStepCost(
    ...
    step8Latency,
    step8Costs.cost,
    step8Costs.processingUnits,
    "Compare new vibe vs profile dominant vibe",
    "local"
  ));
  ...
  stepCosts.push(createStepCost(
    ...
    step9Latency,
    step9Costs.cost,
    step9Costs.processingUnits,
    "Update user profile with new entry data",
    "local"
  ));
  ...
  stepCosts.push(createStepCost(
    ...
    step12Latency,
    step12Costs.cost,
    step12Costs.processingUnits,
    "Package final response for delivery",
    "local"
  ));
